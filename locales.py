...
locale_en.group_greeting_message = (
        ...
        '<a href="t.me/tg_inc_softw">community</a> if you\'ve got any questions.')
locale_ru.group_greeting_message = (
        ...
        'в нашем <a href="t.me/tg_inc_softw">Чате</a>, если у вас появятся какие-либо вопросы.')
locale_uk.group_greeting_message = (
        ...
        'в нашому <a href="t.me/tg_inc_softw">чаті</a>, якщо у вас виникнуть будь-які питання.')
locale_de.group_greeting_message = (
        ...
        '<a href="t.me/tg_inc_softw">Gruppe</a> zu fragen.')
locale_it.group_greeting_message = (
        ...
        '<a href="t.me/tg_inc_softw">gruppo</a> se hai domande.')
...
locale_ru.info_message = (
        'Если у вас остались вопросы, вы можете в любое время обратиться в '
